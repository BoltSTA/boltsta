...
def setup_test_data():
    ...
    Returns:
        tuple: Tuple containing ast (parsed modified Verilog AST) and
        mod_input_pins (modified input pins list).
    """
...
@pytest.mark.parametrize("expected_internal_connections", [
    ([['_2_', 'sky130_fd_sc_hd__or3b_2', '_3_', 'sky130_fd_sc_hd__buf_1', 'X_A'],
      ['_3_', 'sky130_fd_sc_hd__buf_1', '_9_', 'sky130_fd_sc_hd__dfxtp_2', 'Q_D'],
      ['_5_', 'sky130_fd_sc_hd__buf_1', '_7_', 'sky130_fd_sc_hd__dfxtp_2', 'Q_D'],
      ['_6_', 'sky130_fd_sc_hd__nand2_2', '_8_', 'sky130_fd_sc_hd__dfxtp_2', 'Q_D'],
      ['_4_', 'sky130_fd_sc_hd__or3b_2', '_5_', 'sky130_fd_sc_hd__buf_1', 'X_A']])
])
def test_extract_unique_internal_nodes(setup_test_data, expected_internal_connections):
    """
    ...
    Args:
        ...
        expected_port_to_node_to_instance (dict): Expected dictionary mapping
        ports to nodes and instances.
    ...
    """
    ast, mod_input_pins, port_to_node_to_instance = setup_test_data
    actual_internal_connections = extract_unique_internal_nodes(ast, mod_input_pins,
