import pytest
from boltsta.readers import preprocess_verilog, parse_modified_verilog, extract_input_output_pins_of_cells
...
def test_extract_input_output_pins_of_cells(setup_verilog_data, expected_input_pins, expected_output_pins):
    """
    ...
    Asserts:
        Compares actual_input_pins and actual_output_pins with expected_input_pins and expected_output_pins respectively.
    """
