...
def test_extract_input_output_ports(setup_verilog_data, expected_input_ports, expected_output_ports):
    """
    ...
    Asserts:
        Compares actual_input_ports and actual_output_ports with expected_input_ports and expected_output_ports respectively.
    """
